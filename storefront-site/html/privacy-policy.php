        ...
        <div class="grid-container">
            <div class="sidebar">
                <nav class="sidebar-nav">
                    <span style="font-size: 1.2em;">Legal Policies</span>
                    <hr>
                    <ul>
                        <li>
            ...
            <div class="privacy-policy">
                <div>
                    ...
                    <nav class="privacy-policy-nav">
                        <ul>
                            <li>
                                <a href="#privacy1">General Data Protection Regulation (GDPR)</a>
                            </li>
                            <li>
                                <a href="#privacy2">Log Files</a>
                            </li>
                            <li>
                                <a href="#privacy3">Cookies and Web Beacons</a>
                            </li>
                            <li>
                                <a href="#privacy4">Google DoubleClick DART Cookie</a>
                            </li>
                            <li>
                                <a href="#privacy5">Our Advertising Partners</a>
                            </li>
                            <li>
                                <a href="#privacy6">Privacy Policies</a>
                            </li>
                            <li>
                                <a href="#privacy7">Third Party Privacy Policies</a>
                            </li>
                            <li>
                                <a href="#privacy8">Children's Information</a>
                            </li>
                            <li>
                                <a href="#privacy9">Online Privacy Policy Only</a>
                            </li>
                            <li>
                                <a href="#privacy10">Consent</a>
                            </li>
                        </ul>
                    </nav>
    
                    <p>At Pandemic Essentials, accessible from http://www.pandemic-essentials.com, one of our main
                        priorities is the privacy of our visitors. This Privacy Policy document contains types of
                        information that is collected and recorded by Pandemic Essentials and how we use it.</p>
                    ...
                    <h2 id="privacy1">General Data Protection Regulation (GDPR)</h2>
                    <p>We are a Data Controller of your information.</p>
    
                    <p>Pandemic Essentials legal basis for collecting and using the personal information described in this
                    ...
                    <ul>
                        <li>Pandemic Essentials needs to perform a contract with you</li>
                        <li>You have given Pandemic Essentials permission to do so</li>
                        <li>Processing your personal information is in Pandemic Essentials legitimate interests</li>
                        <li>Pandemic Essentials needs to comply with the law</li>
                    </ul>
    
                    <p>Pandemic Essentials will retain your personal information only for as long as is necessary for the
                    ...
                    <h2 id="privacy2">Log Files</h2>
    
                    <p>Pandemic Essentials follows a standard procedure of using log files. These files log visitors when
                    ...
                    <h2 id="privacy3">Cookies and Web Beacons</h2>
    
                    <p>Like any other website, Pandemic Essentials uses 'cookies'. These cookies are used to store
                    ...
                    <h2 id="privacy4">Google DoubleClick DART Cookie</h2>
                    ...
                    <h2 id="privacy5">Our Advertising Partners</h2>
                    ...
                    <h2 id="privacy6">Privacy Policies</h2>
    
                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Pandemic
                        Essentials.</p>
    
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                        are used in their respective advertisements and links that appear on Pandemic Essentials, which are
                    ...
                    <p>Note that Pandemic Essentials has no access to or control over these cookies that are used by
                        third-party advertisers.</p>
    
                    <h2 id="privacy7">Third Party Privacy Policies</h2>
    
                    <p>Pandemic Essentials's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <h2 id="privacy8">Children's Information</h2>
                    ...
                    <p>Pandemic Essentials does not knowingly collect any Personal Identifiable Information from children
                    ...
                    <h2 id="privacy9">Online Privacy Policy Only</h2>
    
                    <p>Our Privacy Policy created at GDPRPrivacyPolicy.net) applies only to our online activities and is
                        valid for visitors to our website with regards to the information that they shared and/or collect in
                        Pandemic Essentials. This policy is not applicable to any information collected offline or via
                        channels other than this website.</p>
    
                    <h2 id="privacy10">Consent</h2>
