        ...
        <div class="grid-container">
            ...
            <div class="terms-of-service">
                <div>
                    ...
                    <nav class="terms-of-service-nav">
                        <ul>
                            <li>
                                <a href="#tos1">Access to the Site</a>
                            </li>
                            <li>
                                <a href="#tos2">User Content</a>
                            </li>
                            <li>
                                <a href="#tos3">Third-Party Links & Ads; Other Users</a>
                            </li>
                            <li>
                                <a href="#tos4">Disclaimers</a>
                            </li>
                            <li>
                                <a href="#tos5">Limitation on Liability</a>
                            </li>
                            <li>
                                <a href="#tos6">Copyright Policy</a>
                            </li>
                            <li>
                                <a href="#tos7">General</a>
                            </li>
                            <li>
                                <a href="#tos8">Contact Information</a>
                            </li>
                        </ul>
                    </nav>
    
                    <p>The Pandemic Essentials website located at http://www.pandemic-essentials.com is a copyrighted work
                        belonging to Pandemic Essentials. Certain features of the Site may be subject to additional
                        guidelines,
                    ...
                    <p>These Terms of Use described the legally binding terms and conditions that oversee your use of the
                        ...
                        have
                        the authority and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS OF AGE TO
                        ACCESS
                        THE SITE. IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE
                        SITE.
                    </p>
                    ...
                    <h2 id="tos1">Access to the Site</h2>
                    ...
                    <p>You hereby grant to Company an irreversible, nonexclusive, royalty-free and fully paid, worldwide
                        ...
                        the Site.  You hereby irreversibly waive any claims and assertions of moral rights or
                        attribution with respect to your User Content.</p>
                    ...
                    <p>You agree to indemnify and hold Company and its officers, employees, and agents harmless,
                        ...
                        of applicable laws or regulations or (d) your User Content.  Company reserves the right to
                        ...
                        notify you of any such claim, action or proceeding upon becoming aware of it.</p>
    
                    <h2 id="tos3">Third-Party Links & Ads; Other Users</h2>
                    ...
                    <p><strong>Cookies and Web Beacons.</strong> Like any other website, Pandemic Essentials uses
                        ‘cookies’. These cookies are used to store information including visitors’ preferences, and the
                        pages on the website that the visitor accessed or visited. The information is used to optimize
                        the users’ experience by customizing our web page content based on visitors’ browser type and/or
                        other information.</p>
    
                    <p><strong>Google DoubleClick DART Cookie.</strong> Google is one of a third-party vendor on our
                    ...
                    <h2 id="tos5">Limitation on Liability</h2>
                    ...
                    <h2 id="tos6">Copyright Policy</h2>
                    ...
                    <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek
                        ...
                        should be sent to: 1600 Holloway Ave, San Francisco, CA 94132. After the Notice is received, you
                    ...
                    <h2 id="tos8">Contact Information</h2>
